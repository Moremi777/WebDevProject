...
#the code end here_______________________
...
def self_directed_learning(request):
    return render(request, 'selfDirectedLearning.html')
...
def document_delete(request, id):
    ...
    if request.method == 'POST':
        document.delete()
        return redirect('document_list')  # Redirect to the document list after deletion
