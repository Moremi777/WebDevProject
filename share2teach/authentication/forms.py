...
from .models import User, Educator, Moderator
...
class UserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.user_type not in ['Moderator', 'Educator']:
...
class CustomUserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'email', 'first_name', 'last_name', 'user_type']  # Include user_type here
...
class UserEditForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ['username', 'email', 'first_name', 'last_name', 'user_type', 'is_email_verified']
        widgets = {
